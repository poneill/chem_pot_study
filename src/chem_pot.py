...
# Next, we construct mu-k figs.  This requires summing occupancies
...
# To compute mu-mu_hat figs, we must compare binding probabilities
# for each known binding site at physiological copy number.

# The misclassification rate fig is just a summary of the mu-mu_hat diagrams.

# the k-occupancy figs just generalize mu-mu_hat diagrams to
